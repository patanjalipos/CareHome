    ...
    implements OnInit
{
    ...
    constructor(
        ...
        this.stlstadmissionstatus = [
            {
                name: this.admissionStatus[this.admissionStatus.Active],
                code: this.admissionStatus.Active,
            },
            {
                name: this.admissionStatus[this.admissionStatus.Deceased],
                code: this.admissionStatus.Deceased,
            },
            {
                name: this.admissionStatus[this.admissionStatus.Discharged],
                code: this.admissionStatus.Discharged,
            },
            {
                name: this.admissionStatus[this.admissionStatus.Transferred],
                code: this.admissionStatus.Transferred,
            },
            {
                name: this.admissionStatus[this.admissionStatus.WaitListed],
                code: this.admissionStatus.WaitListed,
            },
            {
                name: this.admissionStatus[this.admissionStatus.Suspended],
                code: this.admissionStatus.Suspended,
            },
            {
                name: this.admissionStatus[this.admissionStatus.Unallocated],
                code: this.admissionStatus.Unallocated,
            },
        ];
        this.stlsttitle = [
            { name: 'Mr', code: 'Mr' },
        ...
        this.stlstgender = [
            ...
            {
                name: 'Intersex or indeterminate',
                code: 'Intersex or indeterminate',
            },
            {
                name: 'Not stated / inadequately described',
                code: 'Not stated / inadequately described',
            },
        ];
        this.stlstmyself = [
            { name: 'Male', code: 'Male' },
        ...
        this.lstDependencyMaster = [
            {
                name: 'Residenttial indenpendent',
                code: 'Residenttial indenpendent',
            },
            {
                name: 'Residenttial some assistance',
                code: 'Residenttial some assistance',
            },
            {
                name: 'Residenttial full assistance',
                code: 'Residenttial full assistance',
            },
        ...
        this.stlstfunding = [
            ...
            {
                name: 'Responsible Local Authority',
                code: 'Responsible Local Authority',
            },
            {
                name: 'Private/Responsible Local Authority',
                code: 'Private/Responsible Local Authority',
            },
        ];
        ...
        this.unsubscribe.add = this.route.queryParams.subscribe((params) => {
            ...
            if (ParamsArray?.length > 0) {
                ...
                this.mode =
                    ParamsArray.find((e) => e.FieldStr == 'mode')?.FieldVal ||
                    'view';
                this.selecteduserid =
    ...
    ngOnInit(): void {
        ...
        if (this.mode == 'add') this.AddResident();
        else {
    ...
    AddResident() {
        ...
        if (UserTypes.SuperAdmin !== this.s_userTypeId) {
            this.ResidentMaster.Homemasterid =
                localStorage.getItem('HomeMasterId');
        }
    }
            ...
            .subscribe({
                next: (data) => {
                    ...
                    if (data.actionResult.success == true) {
                        ...
                        if (
                            this.ResidentMaster?.DateOfBirth != null &&
                            this.ResidentMaster?.DateOfBirth != undefined
                        ) {
                            this.ResidentMaster.DateOfBirth = new Date(
                                this.ResidentMaster.DateOfBirth
                            );
                        }
                        if (
                            this.ResidentMaster?.ProfileImage != null &&
                            this.ResidentMaster?.ProfileImage != undefined
                        ) {
                            var imageFormat =
                                this._UtilityService.getFileExtension(
                                    this.ResidentMaster.ProfileImage
                                );
                            this.ResidentMaster.ProfileImage =
                                'data:image/' +
                                imageFormat +
    ...
    Submit() {
        if (
            this.ResidentMaster.Password != null &&
            this.ResidentMaster.Password != undefined &&
            this.ResidentMaster.Password != ''
        ) {
            this.ResidentMaster.Password =
                this._EncryptDecryptService.encryptUsingAES256(
                    this.ResidentMaster.Password
                );
        }
        ...
        this.ResidentMaster.PayerTelephone =
            this.ResidentMaster.PayerTelephone?.toString() || null;
        ...
        this._UtilityService.showSpinner();
        this.unsubscribe.add = this._MasterServices
            .AddInsertUpdateResidentMaster(formData)
            .subscribe({
                next: (data) => {
                    this._UtilityService.hideSpinner();
