...
import { RestraintChartRoutingModule } from './restraint-chart-routing.module';
...
@NgModule({
  declarations: [
    RestraintChartComponent
  ],
  imports: [
    CommonModule,
    RestraintChartRoutingModule,
    DropdownModule,
    InputTextModule,
    InputTextareaModule,
    FormsModule,
...
export class RestraintChartModule { }
